...
from app.views import inicio, AlumnoListView, TallerListView, MaterialListView, AlumnoCreateView, TallerCreateView, MaterialCreateView, buscar_taller
...
urlpatterns = [
    ...
    path("buscar_talleres/", buscar_taller, name="buscar_talleres"),
]